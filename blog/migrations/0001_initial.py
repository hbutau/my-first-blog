# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-06-11 10:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=200)),
                ('summary', models.TextField()),
                ('picture', models.ImageField(blank=True, max_length=200, null=True, upload_to='presentations')),
                ('attachment', models.FileField(blank=True, max_length=200, null=True, upload_to='presentations')),
                ('text', models.TextField()),
                ('created_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('published_date', models.DateTimeField(blank=True, null=True)),
                ('slug', autoslug.fields.AutoSlugField(editable=False, populate_from='title', unique=True)),
        ...
        migrations.AddField(
            model_name='comment',
            name='post',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='blog.Post'),
        ),
    ]
